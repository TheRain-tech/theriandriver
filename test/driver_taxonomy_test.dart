...
void main() {
  test('DriverTaxonomy region/affiliation/service/vehicle lists match canonical value counts', () {
  ...
  test('DriverTaxonomy.labelFor falls back to the raw value for an unrecognized one', () {
    expect(DriverTaxonomy.labelFor(DriverTaxonomy.regions, 'atlantis'), 'atlantis');
  });
