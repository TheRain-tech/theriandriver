...
void main() {
  ...
  test(
    'updateRegion/updateAffiliation/updateServiceTypes/updateVehicleCategory set the draft',
    () {
  ...
  test(
    'isComplete requires every taxonomy field to be set, not only the pre-existing ones',
    () {
      final service = RegistrationDraftService.instance;
